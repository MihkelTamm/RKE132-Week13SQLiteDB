...
//InsRertCustomer(CreateConnection());
//RemoveCustmoer(CreateConnection());
FindCustomer();
static SQLiteConnection CreateConnection()
{
    SQLiteConnection connection = new SQLiteConnection("Data Source=myRandomDB.db; Version = 3; New = True; Compress = True;");
...
static void InsertCustomer(SQLiteConnection myConnection)
{
    ...
    Console.WriteLine("Enter date of birth 8mm-dd-yyyy):");
